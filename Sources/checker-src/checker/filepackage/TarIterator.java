...
class TarPackageFile implements PackageFile
{
    FileID id;
    ArrayList<String> contents;
    
    TarPackageFile(FileID i, ArrayList<String> cont)
    {
        id = i;
        contents = cont;
    }
...
class TarIterator implements Iterator<PackageFile>
{
    TarInputStream tis;
	TarEntry curr;
    TarEntry next;
    
	TarIterator(TarInputStream t)
	{
        if(t == null)
        {
            curr = null;
    ...
    public PackageFile next()
	{
		...
		return new TarPackageFile(id, contents);
	}
